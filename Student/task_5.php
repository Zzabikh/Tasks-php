...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link ">
        <main id="js-page-content" role="main" class="page-content">
          ...
          $photos = [
                 [
                "bigimg" => "img/demo/gallery/21.jpg",
                "smlimg" => "img/demo/gallery/thumb/21.jpg"
                 ],

                  [
                "bigimg" => "img/demo/gallery/22.jpg",
                "smlimg" => "img/demo/gallery/thumb/22.jpg"
                 ],

                  [
                "bigimg" => "img/demo/gallery/23.jpg",
                "smlimg" => "img/demo/gallery/thumb/23.jpg"
                 ],

                  [
                "bigimg" => "img/demo/gallery/24.jpg",
                "smlimg" => "img/demo/gallery/thumb/24.jpg"
                 ],
          ...
          ?>
                ...
                <?php foreach($photos as $photo):?>
                                <a class="" href="<?php echo $photo['bigimg']?>">
                                    <img class="img-responsive" src="<?php echo $photo['smlimg']?>" alt="image">
                                </a>
                <?php endforeach;?>
                <!--
