...
<?php $users = [
      ...
      "home" => "15 Charist St, Detroit, MI, 48212, USA",
      "status" => "success",
      ...
      "home" => "134 Hamtrammac, Detroit, MI, 48314, USA",
      "status" => "warning",
      "facebook" => "facebook.com",
      "twitter" => "twitter.com",
      "linkedin" => "linkedin.com"
      ...
      "home" => "55 Smyth Rd, Detroit, MI, 48341, USA",
      "status" => "danger",
      "facebook" => "facebook.com",
      "twitter" => "twitter.com",
      "linkedin" => "linkedin.com"
      ...
      "home" => "134 Tasy Rd, Detroit, MI, 48212, USA",
      "status" => "success",
      "facebook" => "facebook.com",
      "twitter" => "twitter.com",
      "linkedin" => "linkedin.com"
      ...
      "home" => "134 Gallery St, Detroit, MI, 46214, USA",
      "status" => "success",
      "facebook" => "facebook.com",
      "twitter" => "twitter.com",
      "linkedin" => "linkedin.com"
      ...
      "home" => " 13 Jamie Rd, Detroit, MI, 48313, USA",
      "status" => "danger",
      "facebook" => "facebook.com",
      "twitter" => "twitter.com",
      "linkedin" => "linkedin.com"
      ...
      "email" => "jimmy.fallan@smartadminwebapp.com",
      "home" => "798 Smyth Rd, Detroit, MI, 48341, USA",
      "status" => "warning",
      "facebook" => "facebook.com",
      "twitter" => "twitter.com",
      "linkedin" => "linkedin.com"
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?php echo $user['home']?></address> 
